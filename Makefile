...
#   Creates the PS1_Solutions.pdf handout.  Removes auxiliary studenlatex files
#   after compilation.
# `make without_solutions`
#   Creates the PS1.pdf handout.  Removes auxiliary latex files after
...
#
# $ latexmk -pvc -jobname="PS1_Solutions"
#
# (Of course, substituting the "PS1" for the assignment root doccument)
#
